...
export const INITIAL_NODES: CanvasNodeItem[] = [
  // --- INGLÉS BRANCH ---
  {
    ...
    data: {
      ...
      categoriaId: 'ingles',
      etiquetas: ['phrasal-verbs', 'business-english', 'reuniones', 'vocabulario'],
      fechaCreacion: '2026-09-14',
      estado: 'en_practica',
      checklist: [
        { id: 'step-ing-1', texto: 'Anotar pronunciación de "bring up" y "follow up"', completado: true },
        { id: 'step-ing-2', texto: 'Crear 3 oraciones de ejemplo aplicadas a proyectos', completado: true },
        { id: 'step-ing-3', texto: 'Utilizar "follow up" en el próximo correo de cliente', completado: false },
      ],
      razonModo: 'manual',
  ...
  // --- PROGRAMACIÓN BRANCH ---
  {
    ...
    data: {
      ...
      etiquetas: ['css', 'frontend', 'layout', 'responsive'],
      fechaCreacion: '2026-09-15',
      estado: 'en_practica',
      checklist: [
        { id: 'step-pr1-1', texto: 'Identificar layout principal (2D ➔ Grid, 1D ➔ Flex)', completado: true },
        { id: 'step-pr1-2', texto: 'Maquetar dashboard con grid-template-areas', completado: false },
        { id: 'step-pr1-3', texto: 'Comprobar colapso en pantallas menores a 768px', completado: false },
      ],
      razonModo: 'manual',
